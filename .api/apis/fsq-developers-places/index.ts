...
class SDK {
   ...
   */
  offlineJobsStatus(
    metadata: types.OfflineJobsStatusMetadataParam
  ): Promise<FetchResponse<200, types.OfflineJobsStatusResponse200>> {
   ...
   */
  offlineJobsExecute(
    metadata: types.OfflineJobsExecuteMetadataParam
  ): Promise<FetchResponse<200, types.OfflineJobsExecuteResponse200>> {
  ...
  offlineJobsInitialize(
    metadata: types.OfflineJobsInitializeMetadataParam
  ): Promise<FetchResponse<200, types.OfflineJobsInitializeResponse200>> {
  ...
  offlineJobsCredentialsRefresh(
    metadata: types.OfflineJobsCredentialsRefreshMetadataParam
  ): Promise<FetchResponse<200, types.OfflineJobsCredentialsRefreshResponse200>> {
   ...
   */
  placeMatch(
    metadata: types.PlaceMatchMetadataParam
  ): Promise<FetchResponse<200, types.PlaceMatchResponse200>> {
...
export type {
  ...
  OfflineJobsCredentialsRefreshMetadataParam,
  OfflineJobsCredentialsRefreshResponse200,
  OfflineJobsExecuteMetadataParam,
  OfflineJobsExecuteResponse200,
  OfflineJobsInitializeMetadataParam,
  OfflineJobsInitializeResponse200,
  OfflineJobsStatusMetadataParam,
  OfflineJobsStatusResponse200,
  PlaceDetailsMetadataParam,
  PlaceDetailsResponse200,
  PlaceFlagMetadataParam,
  PlaceFlagResponse200,
  PlaceMatchMetadataParam,
  PlaceMatchResponse200,
