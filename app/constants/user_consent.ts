...
export const CURRENT_PRIVACY_POLICY_VERSION = '2026-07-15-privacy-v1'
...
export const MODEL_TRAINING_CONTROL_TEXT =
  'Allow Envoy to use eligible content I submit to improve and train Envoy models.'
...
export const ACCOUNT_MODEL_TRAINING_DISCLOSURE_TEXT =
  'Allow Envoy to use my eligible Envoy content to improve and train Envoy models. When enabled, eligible content from both before and after you opt in may be used. Connected email data, credentials, payment data, and direct identifiers are excluded. Turning this off stops your data from being added to new training runs but may not reverse training that has already completed.'
