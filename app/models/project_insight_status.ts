...
export default class ProjectInsightStatus extends BaseModel {
  static table = 'envoy_schema.project_insight_statuses'
  ...
  @hasMany(() => ProjectInsight, { foreignKey: 'statusId' })
